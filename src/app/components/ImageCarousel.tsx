...
export const ImageCarousel: React.FC<ImageCarouselProps> = ({
  ...
  return (
    ...
    >
      <Modal
        open={openPopupCarousel}
        onClose={() => setOpenPopupCarousel(false)}
      >
        <Box
          sx={{
            display: "flex",
      ...
      <IconButton
        onClick={() => (!isModal ? setOpenPopupCarousel(true) : null)}
        sx={{
          border: "none",
